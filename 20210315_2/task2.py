...
class App(Application):
    def create_widgets(self):
        ...
        self.editor = tk.Entry(self, validate='all', validatecommand=(analyze, "%P"))
        self.editor.grid()
        ...
        self.label = tk.Label(self, textvariable=self.label_text, takefocus=1, highlightthickness=2)
